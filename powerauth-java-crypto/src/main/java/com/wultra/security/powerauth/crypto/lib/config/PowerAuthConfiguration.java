...
public class PowerAuthConfiguration {
    ...
    /**
     * Length of authentication code factor in Base64 formatted authentication code (number of bytes encoded to Base64, protocol v3).
     */
    public static final int AUTH_CODE_BINARY_LENGTH_LEGACY = 16;
     ...
     */
    public static final int AUTH_CODE_BINARY_LENGTH_V4 = 32;
