...
public class GenerateVectorDataTest {
    ...
    void testKdfV4() throws Exception {
        ...
        final String[] labels = {
                ...
                KeyLabel.SHARED_SECRET + "/EC_P384",
                KeyLabel.SHARED_SECRET + "/EC_P384_ML_L3",
                KeyLabel.SHARED_SECRET + "/EC_P384_ML_L5",
                KeyLabel.SHARED_SECRET + "/ML_L3",
                KeyLabel.SHARED_SECRET + "/ML_L5",
