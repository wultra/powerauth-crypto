...
public class PowerAuthServerActivation {
	 ...
	 *
	 * @param C_devicePublicKey
	 *            Encrypted device public key.
	 * @param activationIdShort
	 *            Short activation ID.
	 * @param activationOTP
	 *            Activation OTP value.
	 * @param activationNonce
	 *            Activation nonce, used as an initialization vector for AES
	 *            encryption.
	...
	public PublicKey decryptDevicePublicKey(byte[] C_devicePublicKey, String activationIdShort, String activationOTP,
		...
		} catch (IllegalBlockSizeException | InvalidKeySpecException | BadPaddingException | InvalidKeyException
	 ...
	 *            Server public key to be encrypted.
	 * @param devicePublicKey
	 *            Device public key used for encryption.
	 ...
	 * @throws InvalidKeyException
	 *             In case some of the provided keys is invalid.
	 */
	 ...
	 *
	 * @param devicePublicKey
	 *            Public key for computing fingerprint.
