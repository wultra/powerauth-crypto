...
--
CREATE TABLE "POWERAUTH"."PA_APPLICATION_CALLBACK"
(
    "ID"                 VARCHAR2(37 CHAR),
    "APPLICATION_ID"     NUMBER(19,0),
    "NAME"               VARCHAR2(255 CHAR),
...
--
--  Constraints for Table PA_APPLICATION_CALLBACK
--
ALTER TABLE "POWERAUTH"."PA_APPLICATION_CALLBACK" ADD PRIMARY KEY ("ID") USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645 PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT) TABLESPACE "POWERAUTH" ENABLE;
ALTER TABLE "POWERAUTH"."PA_APPLICATION_CALLBACK" MODIFY ("APPLICATION_ID" NOT NULL ENABLE);
