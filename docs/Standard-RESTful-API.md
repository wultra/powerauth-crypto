...
- Application scope: Private key is the application-specific master server private key `KEY_SERVER_ECDSA_P384_PRIVATE` (alternatively `KEY_SERVER_MLDSA65_PRIVATE` / `KEY_SERVER_MLDSA87_PRIVATE` for ML-DSA algorithms).
