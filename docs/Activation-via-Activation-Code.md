...
1. PowerAuth Server decrypts `ACTIVATION_DATA` using an application scoped encryption (level 2, `sh1="/pa/activation"`) and stores `KEY_DEVICE_PUBLIC` at given record.
