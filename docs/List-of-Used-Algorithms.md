...
|-----------------|---------|------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `EC_P384_ML_L3` | Current | **Hybrid PQC Level 3** {::nomarkdown}<ul><li>Key agreement: <code>ECDH (P-384) + ML-KEM-768</code>. Secrets concatenated before KDF.</li><li>Digital signatures: <code>ECDSA (P-384, SHA-384) + ML-DSA-65</code></li></ul>Targets NIST PQC Level 3.{:/} |
| `EC_P384_ML_L5` | Current | **Hybrid PQC Level 5** {::nomarkdown}<ul><li>Key agreement: <code>ECDH (P-384) + ML-KEM-1024</code>. Secrets concatenated before KDF.</li><li>Digital signatures: <code>ECDSA (P-384, SHA-384) + ML-DSA-87</code></li></ul>Targets NIST PQC Level 5.{:/} |
| `EC_P384`       | Current | **Curve: NIST P-384 (`secp384r1`)** {::nomarkdown}<ul><li>Key agreement: <code>ECDH (P-384, SHA-3 KDF)</code></li><li>Digital signatures: <code>ECDSA (P-384, SHA-384)</code></li></ul>No PQC component.{:/} |
| `ML_L3`         | Testing | **PQC-only Level 3** {::nomarkdown}<ul><li>Key agreement: <code>ML-KEM-768</code></li><li>Digital signatures: <code>ML-DSA-65</code></li></ul>Targets NIST PQC Level 3.{:/} |
| `ML_L5`         | Testing | **PQC-only Level 5** {::nomarkdown}<ul><li>Key agreement: <code>ML-KEM-1024</code></li><li>Digital signatures: <code>ML-DSA-87</code></li></ul>Targets NIST PQC Level 5.{:/} |
| `EC_P256`       | Legacy  | **Curve: NIST P-256 (`secp256r1`)** {::nomarkdown}<ul><li>Key agreement: <code>ECDH (P-256)</code></li><li>Digital signatures: <code>ECDSA (P-256, SHA-256)</code></li></ul>Retained for 3.x compatibility only.{:/} |
