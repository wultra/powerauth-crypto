...
| `KMAC-256`             | mobile, server | Message authentication and AEAD tag, also used in KDF constructions.                                                                 |
...
| `Authentication Codes` | mobile, server | KMAC‑256 for factor keys: Possession, Knowledge, Biometry.                                                                           |
